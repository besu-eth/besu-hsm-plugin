 ...
 * end-to-end via DiscV5 handshakes between SoftHSM2-backed validators. DiscV5 is only valid for
 * secp256k1 (per the ENR v4 identity scheme), so no secp256r1 variant exists.
 */
class QbftSecp256k1NativePkcs11V5DiscoveryIntegrationTest extends QbftHsmIntegrationTestBase {
